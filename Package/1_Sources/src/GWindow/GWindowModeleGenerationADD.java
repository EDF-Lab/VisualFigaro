...
public class GWindowModeleGenerationADD extends GWindow {
	...
	public GWindowModeleGenerationADD(GObject p, GObjectInformation info) {
		super(p, info);
		this.position = -1;
	...
	public GWindowModeleGenerationADD(GObject p, GObjectInformation info, Element e, int pos) {
		super(p, info);
		this.position = pos;
	...
	public void initialize() {
		...
		labels.add("Gate Simplification : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		labels.add("Maximum Sons Number : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		labels.add("Loops Suppression : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		labels.add("Negations Suppression : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		...
		modifiableGridForm = new GWidgetModifiableGridForm(this, information, args, widgetClasses, /*parameters*/null);
		...
		this.pack();
		this.setTitle("Fault Tree Generation Model");
	}
	...
	public Element fillDocument() {
		...
		this.root = new Element(information.getLanguage().getBDCTranslation("MODELE_GENERATION_ADD"));
	...
	public void loadXml(Element e) {
		...
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("SIMPLIFICATION_PORTES")).get(0));
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("NB_MAX_FILS_PORTE")).get(0));
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("SUPPRESSION_BOUCLES")).get(0));
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("SUPPRESSION_NEGATIONS")).get(0));
