...
public class GWindowModeleInstanciationFigaro0 extends GWindow {
...
private static final long serialVersionUID = 1L;
	...
	public GWindowModeleInstanciationFigaro0(GObject p, GObjectInformation info) {
		super(p, info);
		this.position = -1;
	...
	public GWindowModeleInstanciationFigaro0(GObject p, GObjectInformation info, Element e, int pos) {
		super(p, info);
		this.position = pos;
	...
	public void initialize() {
		...
		labels.add("Constant Resolution : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		labels.add("Attribute Resolution : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		labels.add("Rules Instanciation : ");
		labels.add("Value : ");
		args.add(labels);
		labels = new Vector<String>();
		...
		this.pack();
		this.setTitle("Figaro 0 Instanciation Model");
	}
	...
	public Element fillDocument() {
		...
		this.root = new Element(information.getLanguage().getBDCTranslation("MODELE_INST_FIG0"));
	...
	public void loadXml(Element e) {
		...
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("RESOLUTION_ATTRIBUTS")).get(0));
		fieldsLoad.add(GXMLElementFactory.refactorElement(e, information.getLanguage().getBDCTranslation("INSTANCIATION_REGLES")).get(0));
