...
public class GWindowNameSimple extends GWindow {
	...
	@Deprecated
	public GWindowNameSimple(GObject p, GObjectInformation info) {
		super(p, info);
		
		initialization();
	}
	
	public GWindowNameSimple(GObject p, GObjectInformation info, String name, int pos) {
		super(p, info);
	...
	public void translateMessage(GMessage message) {
		switch(message.getMessage()) {
			case OK:
				//Element element = new Element(information.getLanguage().getBDCTranslation("DUMMY"));
