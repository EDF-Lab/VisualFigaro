...
public class GWindowGroupeReglesSansNom extends GWindow {
	...
	@Deprecated
	public GWindowGroupeReglesSansNom(GObject p, GObjectInformation info) {
		super(p, info);
		
		initialization();
	}
	
	public GWindowGroupeReglesSansNom(GObject p, GObjectInformation info, String name, int pos) {
		super(p, info);
	...
	public void translateMessage(GMessage message) {
		switch(message.getMessage()) {
			...
			default:
				System.out.println("VisualFigaro : GWindowGroupeReglesSansNom : Unknown message received");
		}
	}
