...
/**
 * Method retrieving the name from an RULE object.
 * @author Guillaume Torrente & Marc Bouissou
 * @see GNameRetrieverMethod
 */
public class GNameRetrieverMethodRuleName extends GNameRetrieverMethod {
	
	public GNameRetrieverMethodRuleName(GLanguage language) {
		super(language);
	}
	...
	public String retrieveName(Element e) {
		System.out.println("Execution Method Rule Name");
		if(e.getChild(language.getBDCTranslation("NOM_REGLE")) == null)
			return "Unknown";
		else
			return e.getChildText(language.getBDCTranslation("NOM_REGLE"));
	}
}
