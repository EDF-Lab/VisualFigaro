...
public class VisualFigaroPlugin extends EditPlugin
{
	public static final String NAME = "visualfigaro";
	public static final String OPTION_PREFIX = "options.visualfigaro.";
}
